program stationsdata

   character(128)   ::   filein,fileout,fileoutaux,initime
   integer(2)       ::   lun,nx,ny,nx_forc,ny_forc
   parameter (nx=572,ny=468,nx_forc=25,ny_forc=17)
   integer          ::   nstations
   parameter (nstations=16)
   ...
   data station / 01,02,03,04,05,06,07,08,09,10,11,12,13,14,15,16 /
   
   integer   ::   pixel(nstations,2)
   integer   ::   kk, tstop
   parameter (tstop = 2920)
...
! -------------------------------------------------------------
   ...
   filein   ='grijalva-flx2d-2007010100'
   fileout  ='grijalva_stations.txt'

   initime   = '2007-01-01.00:00:00'
